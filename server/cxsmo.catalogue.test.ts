...
describe("C✦SMO portfolio catalogue", () => {
  ...
  it("keeps category discovery and fictional pricing internally consistent", () => {
    ...
    expect(getCxsmoProduct("mercury-belt-13").image).toBe("/images/ChatGPTImageAug15,2026,05_33_54PM_9040fa6d.png");
    expect(getCxsmoProduct("chrome-puddle-14").image).toBe("/images/ChatGPTImageAug15,2026,05_36_41PM_15fc31e0.png");
    expect(getCxsmoProduct("lunar-veil-15").image).toBe("/images/ChatGPTImageAug15,2026,05_38_54PM_ceda59d3.png");
    expect(getCxsmoProduct("redline-moto-16").image).toBe("/images/ChatGPTImageAug15,2026,05_31_19PM_a78e56f6.png");
    expect(getCxsmoProduct("silver-crown-case-17").image).toBe("/images/ChatGPTImageAug15,2026,05_40_56PM_24d03e4f.png");
    expect(getCxsmoProduct("stellar-cargo-18").image).toBe("/images/ChatGPTImageAug15,2026,05_23_24PM_0e3d74d4.png");
