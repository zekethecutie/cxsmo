...
const cxsmoFitLibrarySource: FitEntry[] = [
  ...
  { index: "M / 06", group: "Mens", title: "Signal overshirt", category: "Outerwear", listedIds: ["star-denim-jacket-09"], plannedPieces: ["Mens fit sheet / Black Star Overshirt"], image: "/images/cxsmo-fit-men-06-overshirt.png", alt: "Individual C✦SMO mens look in a black star overshirt and baggy black cargo pants" },
  { index: "M / 07", group: "Mens", title: "White hood", category: "Outerwear", listedIds: [], plannedPieces: ["Mens fit sheet / White Star Hood Jacket", "Mens fit sheet / Grey Distressed Cargo"], image: "/images/cxsmo-fit-men-07-white-hood.png", alt: "Individual C✦SMO mens look in a white star hood jacket and distressed cargo jeans" },
  { index: "M / 08", group: "Mens", title: "Sleeveless hardware", category: "Graphics", listedIds: ["star-spear-tank-49", "vector-cargo-42"], plannedPieces: ["Mens fit sheet / Layered black jacket"], image: "/images/cxsmo-fit-men-08-star-tank.png", alt: "Individual C✦SMO mens look in a black star tank and wide cargo pants" },
  { index: "M / 09", group: "Mens", title: "Washed hood", category: "Outerwear", listedIds: [], plannedPieces: ["Mens fit sheet / Washed Star Hood Jacket", "Mens fit sheet / Grey Cargo Denim"], image: "/images/cxsmo-fit-men-09-washed-hood.png", alt: "Individual C✦SMO mens look in a washed hooded jacket and grey cargo denim" },
  { index: "M / 10", group: "Mens", title: "Contrast track", category: "Graphics", listedIds: ["bolt-raglan-48"], plannedPieces: ["Mens fit sheet / Contrast Track Pant"], image: "/images/cxsmo-fit-men-10-contrast-track.png", alt: "Individual C✦SMO mens look in a white contrast long sleeve and black track pants" },
  { index: "M / 11", group: "Mens", title: "Flame sleeve", category: "Graphics", listedIds: ["star-ruched-top-52"], plannedPieces: ["Mens fit sheet / Black Utility Puddle Pant"], image: "/images/cxsmo-fit-men-11-flame-sleeve.png", alt: "Individual C✦SMO mens look in black flame-sleeve starwear and layered pants" },
  { index: "M / 12", group: "Mens", title: "Washed orbit", category: "Graphics", listedIds: ["starburst-knit-41", "wash-cargo-43"], plannedPieces: ["Mens fit sheet / Grey oversized star knit"], image: "/images/cxsmo-fit-men-12-washed-knit.png", alt: "Individual C✦SMO mens look in a washed grey star knit and distressed cargo denim" },
  { index: "M / 13", group: "Mens", title: "Layer break", category: "Outerwear", listedIds: ["nightstar-hood-04"], plannedPieces: ["Mens fit sheet / Black cargo trouser"], image: "/images/cxsmo-fit-men-13-layered-hood.png", alt: "Individual C✦SMO mens look in a layered black hood jacket and cargo trousers" },
  { index: "M / 14", group: "Mens", title: "Charcoal vector", category: "Bottoms", listedIds: ["vector-cargo-42"], plannedPieces: ["Mens fit sheet / Charcoal Star Hoodie"], image: "/images/cxsmo-fit-men-14-charcoal-cargo.png", alt: "Individual C✦SMO mens look in a charcoal hooded layer and black vector cargo pants" },
  { index: "M / 15", group: "Mens", title: "Moto signal", category: "Outerwear", listedIds: ["leather-zip-vest-51", "utility-puddle-44"], plannedPieces: ["Mens fit sheet / Black Moto Outer Layer"], image: "/images/cxsmo-fit-men-15-moto-layer.png", alt: "Individual C✦SMO mens look in a black moto outer layer and baggy cargo pants" },
