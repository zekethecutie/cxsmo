  ...
  return (
    <main className="cxsmo-entry">
      ...
      <section className="cxsmo-entry__hero cxsmo-entry__hero--poster">
        ...
        <div className="cxsmo-entry__poster-word" aria-hidden="true">C<span className="cxsmo-entry__poster-word-space" />SMO</div>
        ...
        <div className="cxsmo-entry__copy">
          <motion.h1 initial={reducedMotion ? false : { opacity: 0, y: 42, scaleY: .84 }} animate={{ opacity: 1, y: 0, scaleY: 1 }} transition={{ duration: .74, delay: .08, ease: [0.16, 1, .3, 1] }}>C<span>✦</span>SMO</motion.h1>
          <p className="cxsmo-entry__statement">A fashion-commerce system built to make the drop feel inevitable.</p>
          ...
          <p className="cxsmo-entry__creator-line">Designed + developed by zxke</p>
        </div>
        <aside className="cxsmo-entry__desktop-note"><MonitorSmartphone size={17} /><div><b>Wide screen recommended</b><span>The editorial sequence is most expansive on desktop and remains responsive on mobile.</span></div></aside>
      </section>
