...
export function CxsmoPosterHome() {
  ...
  const heroWordY = useTransform(heroScroll, [0, 1], ["0%", "76%"]);
  ...
  return <CxsmoShell><div className="cxsmo-poster-home">
    <section ref={heroRef} className="poster-hero">
      ...
      <motion.div className="poster-hero__barcode" style={{ y: heroBarcodeY }}><span>CSX-2002</span><b>01—{String(cxsmoProducts.length).padStart(2, "0")}</b></motion.div><div className="poster-hero__scroll"><MoveDown size={15} /><span>Scroll for the fit signal</span></div>
    </section>
